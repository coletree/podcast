		...
		<div id="inner-content" class="cf">
			...
			<div id="main" class="volume-archive-list cf" role="main">
					...
					<h1 class="archive-title">
						<span><?php _e( '查找内容:', 'bonestheme' ); ?></span> <?php echo esc_attr(get_search_query()); ?>
					</h1>
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> >
						...
						<header class="volume-header-wrap">
							...
							<div class="volume-summary">
								<?php echo mb_strimwidth(strip_tags(apply_filters('the_excerpt', $post->post_content)), 0, 250,"...");?>
							</div>
